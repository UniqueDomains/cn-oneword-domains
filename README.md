# Available .CN One-Word Domains (867)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-867%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-867%20domains-6f42c1">
...
**Public extract:** 867 rows · **Live catalog:** 867 domains · **Median ask:** $0 · **High-demand under $2,500:** 0
...
- `cn.csv`, public CSV extract (867 rows)
- `cn.json`, public JSON extract (867 rows)
...
| --------------------- | ------------------------------------------ |
| 867-row public sample | 867 live domains                           |
