# Available .CN One-Word Domains (805)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-805%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-805%20domains-6f42c1">
...
**Public extract:** 805 rows · **Live catalog:** 805 domains · **Median ask:** $0 · **High-demand under $2,500:** 0
...
- `cn.csv`, public CSV extract (805 rows)
- `cn.json`, public JSON extract (805 rows)
...
| ----------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------- |
| WWWpage.cn        | available | —         | —             | high           | low    | 8      | —             |
| midDecember.cn    | available | —         | —             | high           | low    | 12     | —             |
...
| OKboomer.cn       | available | —         | —             | high           | low    | 9      | —             |
| Germanpizza.cn    | available | —         | —             | high           | low    | 12     | —             |
| QueenElizabeth.cn | available | —         | —             | high           | low    | 15     | —             |
| watches.cn        | resell    | —         | —             | high           | low    | 7      | Dynadot Inc   |
| destination.cn    | resell    | —         | —             | high           | low    | 11     | Dynadot Inc   |
| midFebruary.cn    | available | —         | —             | high           | low    | 12     | —             |
...
| --------------------- | ------------------------------------------ |
| 805-row public sample | 805 live domains                           |
...
> Unique Domains. *Available .CN One-Word Domains*. Version 2026-08-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
