# Available .CN One-Word Domains (866)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-866%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-866%20domains-6f42c1">
...
- `cn.csv`, public CSV extract (866 rows)
- `cn.json`, public JSON extract (866 rows)
...
| --------------------- | ------------------------------------------ |
| 866-row public sample | 866 live domains                           |
