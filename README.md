# Available .CN One-Word Domains (311)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-310%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-311%20domains-6f42c1">
...
> **Important:** this repository is a **public 310-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **311 domains** on the canonical page below.

**Public extract:** 310 rows · **Live catalog:** 311 domains
...
- `cn.csv` — public CSV extract (310 rows)
- `cn.json` — public JSON extract (310 rows)
...
| local.cn          | resell  | —         | —             | 80             | 54     | 5      | Dynadot Inc                         |
...
| elite.cn          | resell  | —         | —             | 90             | 43     | 5      | Web Commerce Communications Limited |
| contact.cn        | resell  | —         | —             | 84             | 43     | 7      | Dynadot Inc                         |
| sovereign.cn      | resell  | —         | —             | 80             | 43     | 9      | 厦门易名科技股份有限公司                        |
...
| --------------------- | ------------------------------------------------ |
| 310-row public sample | 311 live domains                                 |
...
> Unique Domains. *Available .CN One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
