# Available .CN One-Word Domains (310)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-308%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-310%20domains-6f42c1">
...
> **Important:** this repository is a **public 308-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **310 domains** on the canonical page below.

**Public extract:** 308 rows · **Live catalog:** 310 domains
...
- `cn.csv` — public CSV extract (308 rows)
- `cn.json` — public JSON extract (308 rows)
...
| ----------------- | ------- | --------- | ------------- | -------------- | ------ | ------ | ----------------------------------- |
| affirm.cn         | resell  | —         | —             | 80             | 81     | 6      | 浙江贰贰网络有限公司                          |
| Germanshepherd.cn | premium | —         | —             | 66             | 16     | 15     | —                                   |
| lens.cn           | resell  | —         | —             | 62             | 69     | 4      | Dynadot Inc                         |
| Californian.cn    | premium | —         | —             | 78             | 5      | 11     | —                                   |
| BBC.cn            | resell  | —         | —             | 84             | 66     | 3      | 厦门三五互联信息有限公司                        |
| RomanCatholic.cn  | premium | —         | —             | 66             | 4      | 14     | —                                   |
| nationwide.cn     | resell  | —         | —             | 76             | 66     | 10     | Dynadot Inc                         |
| Latinalphabet.cn  | premium | —         | —             | 68             | 2      | 14     | —                                   |
| priceless.cn      | resell  | —         | —             | 79             | 65     | 9      | Dynadot Inc                         |
| Christianname.cn  | premium | —         | —             | 66             | 2      | 14     | —                                   |
| wallet.cn         | resell  | —         | —             | 74             | 54     | 6      | Dynadot Inc                         |
| FannyAdams.cn     | premium | —         | —             | 56             | 2      | 11     | —                                   |
| local.cn          | resell  | —         | —             | 80             | 53     | 5      | Dynadot Inc                         |
| sweetFA.cn        | premium | —         | —             | 42             | 2      | 8      | —                                   |
| david.cn          | resell  | —         | —             | 74             | 46     | 5      | united-domains GmbH                 |
| based.cn          | resell  | —         | —             | 82             | 45     | 5      | 阿里云计算有限公司（万网）                       |
| contact.cn        | resell  | —         | —             | 84             | 43     | 7      | Dynadot Inc                         |
| scale.cn          | resell  | —         | —             | 78             | 43     | 5      | Dynadot Inc                         |
| elite.cn          | resell  | —         | —             | 90             | 42     | 5      | Web Commerce Communications Limited |
| learn.cn          | resell  | —         | —             | 82             | 42     | 5      | 厦门易名科技股份有限公司                        |
...
| --------------------- | ------------------------------------------------ |
| 308-row public sample | 310 live domains                                 |
...
> Unique Domains. *Available .CN One-Word Domains*. Version 2026-04-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
