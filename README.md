...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-311%20rows-8250df">
...
**Public extract:** 311 rows · **Live catalog:** 311 domains
...
- `cn.csv` — public CSV extract (311 rows)
- `cn.json` — public JSON extract (311 rows)
...
| scale.cn          | resell  | —         | —             | 78             | 44     | 5      | Dynadot Inc                         |
...
| --------------------- | ------------------------------------------------ |
| 311-row public sample | 311 live domains                                 |
...
> Unique Domains. *Available .CN One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
