# Available .CN One-Word Domains (933)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-933%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-933%20domains-6f42c1">
...
**Public extract:** 933 rows · **Live catalog:** 933 domains · **Median ask:** $0 · **High-demand under $2,500:** 0
...
- `cn.csv`, public CSV extract (933 rows)
- `cn.json`, public JSON extract (933 rows)
...
| -------------- | ------ | --------- | ------------- | -------------- | ------ | ------ | ----------------------------------- |
| structure.cn   | resell | —         | —             | high           | low    | 9      | Dynadot Inc                         |
| mature.cn      | resell | —         | —             | high           | low    | 6      | Dynadot Inc                         |
| swiss.cn       | resell | —         | —             | high           | medium | 5      | 阿里云计算有限公司（万网）                       |
| watches.cn     | resell | —         | —             | high           | low    | 7      | Dynadot Inc                         |
| elite.cn       | resell | —         | —             | high           | medium | 5      | Web Commerce Communications Limited |
| cheese.cn      | resell | —         | —             | high           | low    | 6      | Dynadot Inc                         |
| begin.cn       | resell | —         | —             | high           | low    | 5      | 厦门易名科技股份有限公司                        |
| organic.cn     | resell | —         | —             | high           | low    | 7      | Dynadot Inc                         |
| invitation.cn  | resell | —         | —             | high           | low    | 10     | Dynadot Inc                         |
| volleyball.cn  | resell | —         | —             | high           | low    | 10     | 厦门易名科技股份有限公司                        |
| snack.cn       | resell | —         | —             | high           | low    | 5      | Dynadot Inc                         |
| individual.cn  | resell | —         | —             | high           | low    | 10     | Dynadot Inc                         |
| adventure.cn   | resell | —         | —             | high           | medium | 9      | Dynadot Inc                         |
| companion.cn   | resell | —         | —             | high           | low    | 9      | —                                   |
| arcade.cn      | resell | —         | —             | high           | low    | 6      | —                                   |
| diary.cn       | resell | —         | —             | high           | low    | 5      | —                                   |
| jewels.cn      | resell | —         | —             | high           | low    | 6      | Dynadot Inc                         |
| scuba.cn       | resell | —         | —             | high           | low    | 5      | —                                   |
| remote.cn      | resell | —         | —             | high           | medium | 6      | Dynadot Inc                         |
| destination.cn | resell | —         | —             | high           | low    | 11     | Dynadot Inc                         |
...
| --------------------- | ------------------------------------------ |
| 933-row public sample | 933 live domains                           |
...
> Unique Domains. *Available .CN One-Word Domains*. Version 2026-09-26. Public GitHub extract for the exact Unique Domains search represented by this repository.
